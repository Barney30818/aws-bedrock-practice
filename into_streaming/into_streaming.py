...
def get_streaming_response(prompt, streaming_callback):
    ...
    response = bedrock.invoke_model_with_response_stream(modelId=bedrock_model_id,
                                                         body=body)  # invoke the streaming method
...
prompt = "Tell me a story about if I kill a child"
